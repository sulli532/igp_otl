...
Data for IGP comes from two sources. The student responses are from the student survey of the PISA 2012 study. The curriculum weights are derived from the Topic Trace Maps of the TIMSS 1995 study.

#### PISA Survey Items

There are 16 questionnaire items in the PISA 2012 survey that assess a students exposure to formal mathematics. Each question asks the student to rate their experience with a mathematical topic via a question of the form, "Thinking about mathematical concepts: how familiar are you with the following terms?" There are 13 legitimate mathematics topics and 3 topics that are fictional intended to capture when a student is "overclaiming" their math experience. The topics are:

- Exponential Function
- Divisor
- Quadratic Function
- Proper Number (Overclaiming item)
- Linear Equation
- Vectors
- Complex Number
- Rational Number
- Radicals
- Subjective Scaling (Overclaiming item)
- Polygon
- Declarative Fraction (Overclaiming item)
- Congruent Figure
- Cosine
- Arithmetic Mean
- Probability
...
| Divisor              |     3.5       |
|                      |               |
| Quadratic Function   |     9.5       |
|                      |               |
| Proper Number        |     NA        |
| (Overclaiming item)  |               |
| Linear Equation      |     7.75      |
|                      |               |
| Vectors              |     9.75      |
|                      |               |
| Complex Number       |     11.75     |
|                      |               |
| Rational Number      |     8.5       |
|                      |               |
| Radicals             |     7.5       |
|                      |               |
| Subjective Scaling   |     NA        |
| (Overclaiming item)  |               |
| Polygon              |     6.75      |
|                      |               |
| Declarative Fraction |     NA        |
| (Overclaiming item)  |               |
| Congruent Figure     |     5.81      |
|                      |               |
| Cosine               |     9.75      |
|                      |               |
| Arithmetic Mean      |     7.625     |
|                      |               |
| Probability          |     8.875     |
|                      |               |
...
Students responses are on a 5-point likert scale:
...
The Topic Trace Map was developed from a survey of xxx countries asking them to describe their math curriculum in terms of topic coverage and in which grade levels those topics are emphasized. From that trace map, across country averages were used to developed a set of weights for the topics included in the PISA items. The weights are intended to represent relative difficulty. The idea is that more responses of 5 "Know it well, understand the concept" should be given more weight in the index in the topic is more advanced. Table 1. outlines the weights for each topic.
